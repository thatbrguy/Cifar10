...
#Place the data_batch_1 to 5 in the same directory as of train.py before executing.
...
def get_data():
	...
	for i in range(5):
	    ...
	    try:
	        ...
	        print('Place all "data_batch" files (1 to 5) in the current directory')
	        print('Download From: https://www.cs.toronto.edu/~kriz/cifar.html')
	        print('Or get it from my zip-file submission for round3 (email)')
	        print('...Terminating...')
	        exit()
	    images = x[b'data']
	    labval = x[b'labels']
...
def train():
	...
	with tf.Session() as sess:
	    ...
	    print('...Batch wise cost will be printed every 200 batches...')
	    print('...Ignore the sci-kit learn warning...')
	    ...
	    for i in range(epochs):
	        ...
	        if(i == (epochs-1)):
	        	filter = Wconv1.eval(session = sess)
	        	np.save('filters.npy',filter)

	    np.save('test.npy', acc_epochs)
